    ...
    return (
        <main className="flex flex-col justify-center items-center" style={{ marginTop: "20%" }}>
            ...
            <div className="flex flex-col gap-3 m-8">
                <a
                    className="text-normal font-bold text-center leading-none px-5 py-4 rounded-2xl cursor-pointer bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-300 hover:text-black dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700"
                    href="https://testflight.apple.com/join/ohOnY6yp"
                >
                    Join the iOS Beta
                </a>
                <Link
